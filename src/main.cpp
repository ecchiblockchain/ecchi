...
unsigned int nTargetSpacing = 1 * 30; // 30 secs
...
const string strMessageMagic = "ecchi Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 10) // ECCHI FULL-AIRDROP (First Full-Airdrop crypto)
    {
        nSubsidy = 4000000 * COIN;
    }
    else if(pindexBest->nHeight < 800000) // 0 Block Reward as Backup
    {
        nSubsidy = 0 * COIN;
    }
...
// ecchi: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ecchi", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "ECCHI FIRST FULL AIRDROP TITS CRYPTO";
        CTransaction txNew;
        txNew.nTime = 1465318787;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x8812090a15695399c6d216207b455876e17405b3b707729a62843ba7630a5bbc"));
        block.print();
